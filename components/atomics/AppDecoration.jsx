    ...
    case 'threeline':
      return (
        <div className="text-center mt-2 mb-3 lg:mb-5">
          <span className="inline-block bg-primary dark:bg-dark-primary w-[1.5px] lg:w-[2px] h-8 lg:h-9" />
          <span className="inline-block bg-black dark:bg-dark-black w-[1.5px] lg:w-[2px] h-8 lg:h-9 mx-1 lg:mx-[5px] -mb-2" />
          <span className="inline-block bg-primary dark:bg-dark-primary w-[1.5px] lg:w-[2px] h-8 lg:h-9" />
        </div>
      );
    default:
